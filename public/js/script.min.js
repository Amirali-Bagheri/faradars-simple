...
$(function() {
    var changeDirection = function (dir, align) {
        // Wrap block tags.
        this.selection.save();
        this.php.wrap(true, true, true, true);
